...
tellraw @a[name="Seoye"] [{"text":"[ worldborder reset ]","color":"yellow","hoverEvent":{"action":"show_text","value":[{"text":"월드보더 리셋"}]},"clickEvent":{"action":"run_command","value":"/function lifeless:settings/worldborder_reset"}}]