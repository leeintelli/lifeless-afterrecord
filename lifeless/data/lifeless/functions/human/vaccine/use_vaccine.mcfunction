...
execute as @e[tag=ability.vaccine] on target if entity @a[team=normalzombie,distance=..10,limit=1,sort=nearest] run function lifeless:normalzombie/become_human